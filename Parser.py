...
def kodi(suchstring):
    url = "http://10.0.1.102/jsonrpc?request=%7B%22jsonrpc%22:%20%222.0%22,%20%22method%22:%20%22Player.GetItem%22," \
          "%20%22params%22:%20%7B%20%22properties%22:%20%5B%22title%22,%20%22album%22,%20%22artist%22," \
          "%20%22season%22,%20%22episode%22,%20%22duration%22,%20%22showtitle%22,%20%22tvshowid%22," \
          "%20%22thumbnail%22,%20%22file%22,%20%22fanart%22,%20%22streamdetails%22%5D,%20%22playerid%22:%201%20%7D," \
          "%20%22id%22:%20%22VideoGetItem%22%7D "
    ...
    # KODI TV-Show:
    a = "{\"id\":\"VideoGetItem\",\"jsonrpc\":\"2.0\",\"result\":{\"item\":{\"album\":\"\",\"artist\":[]," \
        "\"episode\":1,\"fanart\":\"image://http%3a%2f%2fthetvdb.com%2fbanners%2ffanart%2foriginal%2f81189-13.jpg/\"," \
        "\"file\":\"nfs://10.0.1.30/mnt/2T/Serien/Breaking " \
        "Bad/S01/Brak.Bad.s01e01.Der.Einstieg.Ger.AC51.DL.72p.BRay.x264-Kristallprinz.mp4\",\"id\":3466," \
        "\"label\":\"Der Einstieg\",\"season\":1,\"showtitle\":\"Breaking Bad\",\"streamdetails\":{\"audio\":[]," \
        "\"subtitle\":[],\"video\":[]},\"thumbnail\":\"image://http%3a%2f%2fthetvdb.com%2fbanners%2fepisodes%2f81189" \
        "%2f349232.jpg/\",\"title\":\"Der Einstieg\",\"tvshowid\":165,\"type\":\"episode\"}}} "
    # KODI Movie:
    ...
    if position > 0:
        ...
        if position2 < 0:  # filter das Ende des JSON-Objektes heraus (kein ," mehr vorhanden)
            position2 = ende - 3
        wert = (a[position + start - 1:position2])  # gibt den Wert des Suchbegriffes aus
        if wert[-1:] == "\"":  # filtert den nummerischen Wert von "episode" aus
            wert = (a[position + start:position2 - 1])
